...
Use the top navigation bar to switch between modules. The sidebar within each module provides access to sub-pages. Your available modules depend on your assigned [role](../admin-guide/roles.md) and the deployment's [UI module configuration](../deployment/configuration.md).
